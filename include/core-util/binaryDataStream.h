...
template<class BinaryDataBuffer, bool useCompression>
__forceinline BinaryDataStream<BinaryDataBuffer, useCompression>& operator<<(BinaryDataStream<BinaryDataBuffer, useCompression>& s, UINT64 i) {
	s.writeData(i);
	return s;
}
template<class BinaryDataBuffer, bool useCompression>
__forceinline BinaryDataStream<BinaryDataBuffer, useCompression>& operator<<(BinaryDataStream<BinaryDataBuffer, useCompression>& s, int i) {
	s.writeData(i);
	return s;
}
template<class BinaryDataBuffer, bool useCompression>
__forceinline BinaryDataStream<BinaryDataBuffer, useCompression>& operator<<(BinaryDataStream<BinaryDataBuffer, useCompression>& s, unsigned int i) {
	s.writeData(i);
	return s;
}
template<class BinaryDataBuffer, bool useCompression>
__forceinline BinaryDataStream<BinaryDataBuffer, useCompression>& operator<<(BinaryDataStream<BinaryDataBuffer, useCompression>& s, short i) {
	s.writeData(i);
	return s;
}
template<class BinaryDataBuffer, bool useCompression>
__forceinline BinaryDataStream<BinaryDataBuffer, useCompression>& operator<<(BinaryDataStream<BinaryDataBuffer, useCompression>& s, unsigned short i) {
	s.writeData(i);
	return s;
}
template<class BinaryDataBuffer, bool useCompression>
__forceinline BinaryDataStream<BinaryDataBuffer, useCompression>& operator<<(BinaryDataStream<BinaryDataBuffer, useCompression>& s, char i) {
	s.writeData(i);
	return s;
}
template<class BinaryDataBuffer, bool useCompression>
__forceinline BinaryDataStream<BinaryDataBuffer, useCompression>& operator<<(BinaryDataStream<BinaryDataBuffer, useCompression>& s, unsigned char i) {
	s.writeData(i);
	return s;
}
template<class BinaryDataBuffer, bool useCompression>
__forceinline BinaryDataStream<BinaryDataBuffer, useCompression>& operator<<(BinaryDataStream<BinaryDataBuffer, useCompression>& s, float i) {
	s.writeData(i);
	return s;
}
template<class BinaryDataBuffer, bool useCompression>
__forceinline BinaryDataStream<BinaryDataBuffer, useCompression>& operator<<(BinaryDataStream<BinaryDataBuffer, useCompression>& s, double i) {
	s.writeData(i);
	return s;
}

template<class BinaryDataBuffer, bool useCompression, class T>
__forceinline BinaryDataStream<BinaryDataBuffer, useCompression>& operator<<(BinaryDataStream<BinaryDataBuffer, useCompression>& s, const std::vector<T>& v) {
	s << (UINT64)v.size();
...
template<class BinaryDataBuffer, bool useCompression, class T>
__forceinline BinaryDataStream<BinaryDataBuffer, useCompression>& operator<<(BinaryDataStream<BinaryDataBuffer, useCompression>& s, const std::list<T>& l) {
	s << (UINT64)l.size();
...
template<class BinaryDataBuffer, bool useCompression, class T>
__forceinline BinaryDataStream<BinaryDataBuffer, useCompression>& operator>>(BinaryDataStream<BinaryDataBuffer, useCompression>& s, std::vector<T>& v) {
	UINT64 size;
	s >> size;
	v.resize(size);
	for (size_t i = 0; i < v.size(); i++) {
