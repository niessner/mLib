...
class CGALWrapper {
public:
	static std::vector<point3d<FloatType>> convexHull(typename std::vector<point3d<FloatType>>::const_iterator begin, typename std::vector<point3d<FloatType>>::const_iterator end) {
